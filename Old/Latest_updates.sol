...
contract LetterCredit {
    ...
    //define the bool that the buyer will set to True if she wants to proceed in case of discrepancies or not (False)
    ...
    function buyer_Upload_SetEndTime(string memory hash_buyer, uint _Number_of_Days) external{
    ...
    function Proceed_or_Not(bool _decision) public {
        require(msg.sender == buyer, "Invalid access, only buyer can take this decision");
